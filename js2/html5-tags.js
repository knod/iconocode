...
List of all html5 tags found here: 
...
var HTML5Tags = [
	...
	's', 'samp', 'section', 'select', 'shadow', 'small', 'source', 'spacer', 'span',
	...
	// Took a quick glance, pretty sure these can't be used
	// audio, head, html, ruby, script,
